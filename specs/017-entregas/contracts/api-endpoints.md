...
```http
GET /admin/entregas/buscar-por-dni?dni=412&fecha=2026-06-08&sede_id=uuid&punto_retiro_id=uuid
Authorization: Bearer <token>
x-tenant-key: <tenant>
```
...
| Parámetro         | Tipo            | Requerido | Descripción                                                                                                                                          |
| ----------------- | --------------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dni`             | string          | Sí        | Secuencia de al menos 3 números del DNI. Busca coincidencias parciales, por ejemplo `412` matchea `30412567`. Se ignoran puntos, guiones y espacios. |
...
| 400         | `BAD_REQUEST` | `dni` tiene menos de 3 números luego de normalizarlo        |
